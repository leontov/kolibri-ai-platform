...
ALTER TABLE users
    ADD COLUMN preferred_service_tier TEXT
    CHECK (
...
CREATE TABLE chat_run_execution_contexts_v26 (
...
INSERT INTO chat_run_execution_contexts_v26 (
    tenant_id,
    run_id,
    execution_mode,
    access_mode,
...
SELECT
    ...
    CASE
        WHEN execution_mode = 'developer'
             AND sandbox_profile = 'workspace-write' THEN 'auto'
        WHEN execution_mode = 'developer' THEN 'full'
        ELSE 'standard'
    END,
    CASE
        WHEN execution_mode = 'developer'
             AND sandbox_profile = 'workspace-write' THEN 1
        ELSE 2
    END,
    authority_role,
    authority_user_id,
...
ALTER TABLE chat_run_execution_contexts_v26
