...
ALTER TABLE estimate_exports RENAME TO estimate_exports_before_docx;
...
CREATE TABLE estimate_exports (
    ...
    format TEXT NOT NULL
        CHECK (format IN ('pdf', 'xlsx', 'docx', 'csv')),
...
SELECT
    ...
    artifact_hash, size_bytes, content_blob,
    created_by_user_id, created_at
FROM estimate_exports_before_docx;

DROP TABLE estimate_exports_before_docx;
